...
export class SuggestedAlternativeDto {
  ...
  @ApiProperty({
    description: 'Alternative end',
    format: 'date-time',
    example: '2024-12-26T18:00:00.000Z',
  })
  endTs: Date;
...
export class NextStepDto {
  @ApiProperty({
    ...
    enum: ['payment', 'confirmation', 'wait'],
    example: 'payment',
  })
  action: string;
  ...
  @ApiProperty({
    ...
    example: 'Complete payment within 30 minutes',
  })
  description: string;
  ...
  @ApiPropertyOptional({
    description: 'Payment URL if action is payment',
    example: 'https://rzp.io/i/KKBLjhmr',
  })
  paymentUrl?: string;
}
...
export class BulkErrorDto {
  ...
  @ApiProperty({
    ...
    example: 'Venue is not available at the requested time',
  })
  message: string;
...
export class BookingResponseDto {
  ...
  @ApiPropertyOptional({
    description: 'Whether payment is required for this booking',
    example: true,
  })
...
export class BulkResultDto {
  @ApiPropertyOptional({
    description: 'Processed booking',
    type: () => BookingResponseDto,
  })
  booking?: BookingResponseDto;

  @ApiPropertyOptional({
    description: 'Error object for failed item',
    type: () => BulkErrorDto,
  })
  error?: BulkErrorDto;
}
